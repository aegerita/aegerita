...
If you like the way I greet you, check out this [Todo-list](aegerita-todo.netlify.app) - ![GitHub last commit](https://img.shields.io/github/last-commit/aegerita/Vue-TodoList) <br>
If you like flowers, check out this [Android app](https://play.google.com/store/apps/details?id=com.aegerita.spot_a_flower) - ![GitHub last commit](https://img.shields.io/github/last-commit/aegerita/Spot-A-Flower) ![GitHub release (latest by date)](https://img.shields.io/github/v/release/aegerita/Spot-A-Flower)
